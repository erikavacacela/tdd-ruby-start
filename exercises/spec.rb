  ...
  RSpec.describe Person do
    describe "#full_name" do
      ...
      it "does not add extra spaces if middle name is missing" do
        ...
        actual_person = Person.new(:first_name => 'Eduardo', :last_name => 'Cachavilano')
    ...
    describe "#full_name_with_middle_initial" do
      it "returns a full name with a middle initial with spaces" do
        ...
        actual_person = Person.new(:first_name => 'Valentin', :middle_name => 'Wos', :last_name => 'Oliva')

        expect(actual_person.full_name_with_middle_initial()).to eq(expected_full_name)
      end 

      it "does not add extra spaces if middle name is missing" do
        expected_full_name = 'Valentin Oliva'

        actual_person = Person.new(:first_name => 'Valentin', :last_name => 'Oliva')
